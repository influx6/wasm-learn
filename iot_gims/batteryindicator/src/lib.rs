...
// define method we wish to use from external provider
extern "C" {
    fn set_led(led_index: i32, r: i32, g: i32, b: i32); // (2)
}


// we expose this method as an external function others can call
#[no_mangle]
pub extern "C" fn sensor_update(sensor_id: i32, sensor_value: f64) -> f64 { // (3)
...
fn get_led_values(battery_remaining: f64) -> [LedColor; 8] { // (4)
