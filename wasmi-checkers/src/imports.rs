...
// We implement a module resolver that knows who/what to call
// for function execution.
// It will match the function signature to a specified index
// which our runtime will use to invoke the correct function.
