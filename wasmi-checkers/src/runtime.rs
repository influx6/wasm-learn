...
// We will implement a runtime that handle the execution of imported
// functions in the wasm module.
pub struct Runtime {} // (1)
...
// We will implement the invoke_index function used by wasm to
// execute function based on target index -> check the wasm source.
